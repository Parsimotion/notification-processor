...
describe "JobsProcessor: ", ->
  ...
  context "when API response with bad status code", ->
    it "and dequeue counter is lower than MAX_DEQUEUE_COUNT, should throw an exception", ->
      _nockAPI(400, "something went wrong!")
